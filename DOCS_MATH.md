...
Diese Dokumentation beschreibt die **geplanten** mathematischen und technischen Konzepte für die generischen Marktdefinitionen (Stochastic Factors) und die Monte-Carlo-Simulation. Sie dient als Spezifikation für die Engine-Implementierung in **CashflowSimulator.Engine** (derzeit noch nicht implementiert).
