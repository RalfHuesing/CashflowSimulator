...
- **Simulation:** Läuft asynchron (`ISimulationRunner.RunSimulationAsync`); UI bleibt reaktionsfähig. Persistenz erfolgt per Batch (`ISimulationResultRepository.WriteMonthlyResultsAsync`) in einer Transaktion pro Run (kein N+1).
